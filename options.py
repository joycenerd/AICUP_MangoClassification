...
parser.add_argument('--model',type=str,default="efficientnet-b5",help="which model: [resenest50, resnest101, resnest200, resnest269, efficientnet-b4]")
...
parser.add_argument('--train_batch_size',type=int,default=4,help='The batch size for training data')
...
parser.add_argument('--img_size', type=int, default=456, help='Input image size')
