...
parser.add_argument('--model',type=str,default="efficientnet-b4",help="which model: [resenest50, resnest101, resnest200, resnest269, efficientnet-b4, efficientnet-b5]")
...
parser.add_argument('--train_batch_size',type=int,default=12,help='The batch size for training data')
...
parser.add_argument('--checkpoint_dir',type=str,default=Path(ROOTPATH).joinpath('checkpoint/efficientnet-b4'),help='Directory to save all your checkpoint.pth')
