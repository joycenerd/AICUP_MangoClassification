...
parser.add_argument('--model',type=str,default="resnest200",help="which model: [resenest50, resnest101, resnest200]")
parser.add_argument('--lr',type=float,default=0.0046875,help="learning rate")
parser.add_argument('--cuda_devices',type=int,default=0,help='gpu device')
parser.add_argument('--epochs',type=int,default=270,help='num of epoch')
...
parser.add_argument('--dev_batch_size',type=int,default=8,help='The batch size for development data')
