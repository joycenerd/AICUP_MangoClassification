...
parser.add_argument('--model',type=str,default="resnest101",help="which model: resenest50, resnest101")
parser.add_argument('--lr',type=float,default=0.009375,help="learning rate")
...
parser.add_argument('--dev_batch_size',type=int,default=20,help='The batch size for development data')
