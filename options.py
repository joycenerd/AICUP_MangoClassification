...
parser.add_argument('--model',type=str,default="resnest269",help="which model: [resenest50, resnest101, resnest200, resnest269]")
parser.add_argument('--lr',type=float,default=0.003125,help="learning rate")
