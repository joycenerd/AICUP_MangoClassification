...
parser.add_argument('--model',type=str,default="efficientnet-b3",help="which model: [resenest50, resnest101, resnest200, resnest269, efficientnet-b4, efficientnet-b5]")
...
parser.add_argument('--train_batch_size',type=int,default=24,help='The batch size for training data')
parser.add_argument('--num_workers',type=int,default=4,help='The number of worker while training')
parser.add_argument('--dev_batch_size',type=int,default=1,help='The batch size for development data')
parser.add_argument('--checkpoint_dir',type=str,default=Path(ROOTPATH).joinpath('checkpoint/efficientnet-b3'),help='Directory to save all your checkpoint.pth')
